...
<head>
    ...
    <script type="text/javascript">
        ...
        function letterkind() {
        	let letterkind = $("[name=whether]").val();
        	document.letterForm.action = "letterViewAllAction.do?whether=" + letterkind;
        	document.letterForm.submit();
        }
        
        function openLetter(l_no){
        	var searchData = $(location).attr('search').split('=')[1];
        	var width = 500;
            var height = 400;
            ...
            const url_letter = "letterViewOneAction.do?l_no=" + l_no + "&whether=" + searchData

            window.open(url_letter, "letter popup", windowStatus);
        ...
        function writeLetter(){
            ...
            const url_letter = "./writeLetter.jsp"
                ...
                <div class="col-xs-9" id="navbarRight" style="height: 70px;">
                    ...
                    <div style="float: right;">
                        <div id="search" class="btn-group fac-btn btn btn-default btn-nav active search-UI"
                            ...
                            <input type="text" data-placement="left" id="search-input" value placeholder="쪽지 검색"
                                data-toggle="tooltip" data-original-title="찾고 싶은 게시물의 제목을 입력해주세요." autocomplete="off">
                        </div>
                    
                    	<span class="center btn left-btn">
                        	<a href="#" style="cursor: pointer; color: #777; font-weight: 500; font-size: 18px; padding: 15px 0 15px 0;" onclick="location.href='./post.jsp';">쪽지함</a> 
						</span> 
                        <span class="center btn left-btn">
        ...
        <div class="col-xs-9">
	        <form name="letterForm" action="letterDeleteAction.do" method="post" >
                ...
                <div class="title main-title">
                	<select name="whether" onChange="letterkind();">
                		<option value="received">받은</option>
                		<option value="sent">보낸</option>
                	</select>
                    <h3 class="title-name">쪽지함</h3>
                	<button name="wirteLetter" type="button" onClick="writeLetter();">쪽지쓰기</button>
                </div>
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							...
							<th style="background-color: #eeeeee; text-align: center;">보낸 사람</th>
					...
					<tbody>
						<tr>
							<c:forEach var="ll" items="${LList}">
	                           <tr>
	                       		  <td><input type="checkbox" name="letter_no_arr" value="${ll.l_no}"></td>
