                ...
                <div class="bg-white tm-block">
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-12 text-center">
                            <img alt="logo" src="./img/logo1.png" class="logo">
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="loginAction.do" method="post" class="loginForm" name="loginForm"
                                ...
                                <div class="input-group">
                                	<label style="top: 10px; font-size: 25px;">찾으시는 아이디는: ${u_id}</label>
                                </div>
                                <div class="input-group mt-3" style="width: 100%;">
                                    <button type="button" class="btn btn-primary d-inline-block mx-auto" name="selfclose"
                                        style="font-size: 20px; width: 100%; padding: 10px;" onclick="self.close();">확인</button>
                                </div>
                            </form>
                            <div class="input-group mt-3" style="width:100%;">
