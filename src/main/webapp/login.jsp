        ...
        <div class="row tm-mt-big">
            <div class="col-12 mx-auto tm-login-col">
                <div class="bg-white tm-block">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="loginAction.do" method="post" class="loginForm" name="loginForm"
                                style="padding: 30px 30px 30px 30px;">
                                <div class="input-group">
                                    <i class="fa-solid fa-user"
                                        style="position: absolute; top: 17px; left: 12px; opacity: .6;"></i>
                                    <input name="u_id" type="text" class="admin_id" id="admin_id" placeholder="아이디"
                                        style="width: 100%; padding: 10px 10px 10px 35px; border-radius: 10px 10px 0 0; border: 1px solid #dadada; border-bottom: none; opacity: .6;">
                                </div>
                                <div class="input-group">
                                    <i class="fa-solid fa-lock"
                                        style="position: absolute; top: 17px; left: 12px; opacity: .6;"></i>
                                    <input name="u_pw" type="password" class="pwd" id="pwd" placeholder="비밀번호"
                                        style="width: 100%; padding: 10px 10px 10px 35px; border-radius: 0 0 10px 10px; border: 1px solid #dadada; opacity: .6;">
                                </div>
                                <div class="keep_check" style="position:relative; margin-top:10px;">
                                    <input type="checkbox" name="keep_login" id="keep" value="off"
                                        style="width: 15px; height: 15px; position: absolute; top: 5px; left: 2px; cursor: pointer; appearance: none; outline: 1px solid red;">
                                    <label for="keep" class="keep_login" style="margin-left:25px; cursor: pointer;">
                                        아이디, 암호 기억
                                    </label>
                                </div>
                                <div class="input-group mt-3" style="width: 100%;">
                                    <button type="button" class="btn btn-primary d-inline-block mx-auto" name="login"
                                        style="font-size: 20px; width: 100%; padding: 10px;" onclick="selfCloseSubmit()">로그인</button>
                                </div>
                            </form>
                            <div class="input-group mt-3" style="width:100%;">
